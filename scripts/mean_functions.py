...
def plotting_yearly_mean(ds,var="tg", out_dir="/root/climate_eof_group_project/plots/yearly_mean/"):
    ...
    for idx, t in enumerate(times):
        ...
        plt.savefig(out_dir + f'mean {var} for {year_label}', dpi=150, bbox_inches="tight")
        fig.tight_layout()
        plt.close()
