...
def make_sample_era5_t2m():
    ...
    # our code expects:
    # the same coordinate structure of time, latitude, longitude, t2m
    ...
    # data generates synthetic temperature data for:
    # every timestamp, latitude, and longitude
    # multiplying by 10 and then adding 273.15:
    # gives a range of 0-10 degrees celcius
    ...
    ds = xr.Dataset(
        ...
        attrs={
            "description": "Synthetic ERA5-like temperature dataset"}
    )
    return ds
